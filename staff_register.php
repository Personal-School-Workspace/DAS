...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        $q = "SELECT staff_id FROM staff WHERE (pass=SHA2('$p',512) AND email='$e' )";
        ...
        if ($num < 1) {
            ...
            $q = "INSERT INTO staff (fname, lname, med_id, email, pass) VALUES ('$fn', '$flast', SHA2('$ln',512), '$e', SHA2('$p',512))";
            $r = @mysqli_query ($dbc, $q);
            if ($r) {
