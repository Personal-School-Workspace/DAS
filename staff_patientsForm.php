...
?>
  <main> 
    ...
    $q = "Select patient_id,f_name,m_initial,l_name,age,height,gender,medications,allergies,conditions from patients where Signed_Waiver = 1 AND provider_id = '$staffid'"; 
